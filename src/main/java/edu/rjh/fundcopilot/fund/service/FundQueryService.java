...
import edu.rjh.fundcopilot.fund.entity.AlipayFundPoolDO;
import edu.rjh.fundcopilot.fund.entity.FundMetricSnapshotDO;
import edu.rjh.fundcopilot.fund.entity.FundNavDO;
import edu.rjh.fundcopilot.fund.entity.FundProfileDO;
import edu.rjh.fundcopilot.fund.mapper.AlipayFundPoolMapper;
import edu.rjh.fundcopilot.fund.mapper.FundMetricSnapshotMapper;
import edu.rjh.fundcopilot.fund.mapper.FundNavMapper;
import edu.rjh.fundcopilot.fund.mapper.FundProfileMapper;
import edu.rjh.fundcopilot.fund.vo.FundAnalysisResultVO;
import edu.rjh.fundcopilot.fund.vo.FundDetailVO;
import edu.rjh.fundcopilot.fund.vo.FundMetricVO;
import edu.rjh.fundcopilot.fund.vo.FundNavPointVO;
import edu.rjh.fundcopilot.fund.vo.FundSearchItemVO;
import edu.rjh.fundcopilot.marketdata.FundDataProvider;
import edu.rjh.fundcopilot.marketdata.MarketDataDtos.MarketFundSnapshot;
import edu.rjh.fundcopilot.marketdata.MarketDataDtos.MarketNavPoint;
